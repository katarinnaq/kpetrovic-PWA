    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin-list')" :active="request()->routeIs('dashboard')">
                        {{ __('Lista Svih Proizvoda') }}
                    </x-nav-link>
                </div>
                @endif
                ...
                @if(in_array(Auth::user()->role->name, ['admin', 'editor']))
                 <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin-add')" :active="request()->routeIs('dashboard')">
                        {{ __('Dodaj proizvod') }}
                    </x-nav-link>
                </div>
                @endif
                ...
                @if(in_array(Auth::user()->role->name, ['admin', 'editor']))
                 <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('category-add')" :active="request()->routeIs('dashboard')">
                        {{ __('Dodaj kategoriju') }}
                    </x-nav-link>
                </div>
                @endif
